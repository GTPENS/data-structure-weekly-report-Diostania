...
//fungsi untuk pengurutan data dengan metode Bubble Sort
void BubbleSort()
{
    ...
    for (int i = 0; i < MAX - 1; i++)
    {
        ...
        if (!swapped) break; // Jika tidak ada lagi pertukaran maka pengurutan sudah selesai
        cout << "Iteration " << i + 1 << ": ";
        for (int k = 0; k < MAX; k++) {
            cout << Data[k] << " ";
        }
...
// Prosedur untuk pengurutan data dengan metode Shell Sort
void ShellSort()
{
