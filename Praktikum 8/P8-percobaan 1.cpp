...
// fungsi untuk pengurutan metode Quick Sort non-rekursif
void QuickSortNonRekursif()
{
    // mendeklarasikan tipe data struct untuk tumpukan
    struct Tumpukan {
        int Kiri;
        int Kanan;
    } Tumpukan[MaxStack];
    int i, j, L, R, x, ujung = 1;
    // menginisiasi tumpukan
    Tumpukan[1].Kiri = 0;
...
int main()
{
    ...
    // untuk memanggil fungsi QuickSortNonRekursif untuk mengurutkan data
